...
Balas PERSIS salah satu dari 5 format ini, tanpa markdown fence, tanpa teks lain:
...
export async function planStep(askFn, { instruction, fileSnapshot, history, agentMd }) {
...
Tentuin langkah berikutnya.`;
  ...
  const actionMatch = raw.match(/ACTION:\s*(edit|bash|done|read|list_dir)/);
