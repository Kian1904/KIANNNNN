...
export const askGroq = makeOpenAICompatible({
  ...
  apiKeyEnv: 'GROQ_API_KEY', modelEnv: 'GROQ_MODEL', defaultModel: 'openai/gpt-oss-120b'
});
...
const PROVIDER_ORDER = [
  { name: 'xKiro', fn: askXKiro },
  { name: 'xKrioCoder', fn: askXKiroCoder },
  { name: 'Gemini', fn: askGemini },
  { name: 'OpenRoutee', fn: askOpenRouter },
...
export const PROVIDER_NAMES = [
  { key: 'xkiro',       label: 'xkiro(DeepSeek-V4-Pro)' },
  ...
  {key: 'groq',         label: 'gpt (gpt-oss-120b)'},
];
...
export async function askWithFallback(systemPrompt, userPrompt) {
 ...
 const providerMap = {
  'xkiro': askXKiro, 'xkiro-coder': askXKiroCoder, 'openrouter': askOpenRouter, 'gemini': askGemini, 'mistral': askMistral, 'groq': askGroq
};
const defaultOrder = [askXKiro, askXKiroCoder, askOpenRouter, askGemini, askMistral, askGroq];
