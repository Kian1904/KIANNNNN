...
export const askOpenRouter = makeOpenAICompatible({
  ...
  apiKeyEnv: 'OPENROUTER_API_KEY', modelEnv: 'OPENROUTER_MODEL', defaultModel: 'meta-llama/llama-3.3-70b-instruct:free'
});

export const askNvidia = makeOpenAICompatible({
  name: 'Nvidia', baseUrl: 'https://integrate.api.nvidia.com/v1',
  apiKeyEnv: 'NVIDIA_API_KEY', modelEnv: 'NVIDIA_MODEL', defaultModel: 'meta/llama-3.3-70b-instruct'
});
